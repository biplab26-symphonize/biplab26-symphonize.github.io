...
@Component({
  selector: 'app-charge-account-details',
  templateUrl: './charge-account-details.component.html',
  styleUrls: ['./charge-account-details.component.scss'],
  animations: fuseAnimations
})
export class ChargeAccountDetailsComponent implements OnInit {

  PaginationOpt: any = {};
  public displaySlug: string = 'CHARGE ACCOUNT DETAILS';
  Columns: [];
  StatusList: any;
  ...
  */
  ...
  ngOnInit() {
    ...
    this.Columns = OptionsList.Options.tables.list.mychargeaccount;
    this.displayedColumns = OptionsList.Options.tables.list.mychargeaccount.map(col => col.columnDef);
    ...
    this._usersService.chargeAccountPeriods({ 'cid': this.community_id, 'cstid': cstid }).then(Response => {
  ...
  getPrint(){
   ...
   // this.filterParams['column']     = 'booking_start_date';
    ...
    this._usersService.getPrintPlanAccountEntries('fullcount/gettransaction',params)
  }
  ngOnDestroy(): void {
...
export class FilesDataSource extends DataSource<any>
{
  ...
  */
  getFilteredBookings(params: any) {
    return this._usersService.getChargeAccountDetailsList(params).then(Response => {      
      return Response;
    });
  }
  /**
