...
import { AppointmentBookingService, CommonService, AppConfig,OptionsList } from 'app/_services';
...
export class ViewappointmentsComponent implements OnInit {
  ...
  getBooking(){
    this._appointmentBookingService.getBookingContent(this.url_id)
    .subscribe(response =>
    {
      ...
      if (response.status == 200 ) 
      {
        setTimeout(() => {
          ...
          if(this.content.guestsinfo.length>0 ){
            this.guestdisp = true;
          }
          console.log('content',this.content.guestsinfo.length);  
        },200);
  ...
  getPrint(){
    ...
    params.push(
     ...
     this._appointmentBookingService.getPrintDiningentry('appoinmentbooking/view/appoinmentbooking', params)
   }
