...
import { OptionsList, CommonService, DiningReservationService } from 'app/_services';
...
@Component({
  selector: 'app-mydining',
  templateUrl: './mydining.component.html',
  styleUrls: ['./mydining.component.scss'],
  animations : fuseAnimations
})
export class MydiningComponent implements OnInit {
  
  PaginationOpt           : any = {};
  public displaySlug: string = 'My Dining';
  Columns                 : []; 
  StatusList              : any;
  ...
  ngOnInit() {
      ...
      this.Columns          = OptionsList.Options.tables.list.mydining;
      ...
      this.displayedColumns = OptionsList.Options.tables.list.mydining.map(col => col.columnDef);
      this.dataSource       = new FilesDataSource(this._diningReservationService, this.paginator, this.sort);
  ...
  getPrint(){
    ...
    this._diningReservationService.getPrintDiningBookingEntries('diningreservation/list/diningbooking',params)
 }
  ...
  cancelAll(id) {
    ...
    .subscribe(result => {
      ...
      {   
        ...
        this._diningReservationService.updateBookingStatus(statusData).subscribe(response =>{
    ...
    this.confirmDialogRef.afterClosed()
        .subscribe(result => {
            if ( result )
            {
             ...
             let deleteUrl = 'diningreservation/update/diningbookingclearbooking';
             this._diningReservationService.clearBooking(deleteUrl,deleteData)
...
export class FilesDataSource extends DataSource<any>
{
  ...
  * Constructor
  *
  * @param {DiningReservationService} _diningReservationService
  ...
  */
  ...
  )
  {
    ...
    this.filteredData = this._diningReservationService.bookingList;
  ...
  */
  connect(): Observable<DiningReservationmodel[]>
  {
    const displayDataChanges = [
        this._diningReservationService.onBookingsChanged 
    ...
    return merge(...displayDataChanges)
        ...
        map(() => {
                let data          = this._diningReservationService.bookingList;
  ...
  */
  getFilteredBookings(params:any){
    return this._diningReservationService.getBookingList(params).then(Response=>{
        return Response;
