...
export class ListComponent implements OnInit {
    ...
    constructor(
        ...
        if (this.route.routeConfig.path == "admin/dining-reservation/services/trash") {
    ...
    ngOnInit(): void {
        ...
        this.Columns = OptionsList.Options.tables.list.mybookings;
        this.displayedColumns = OptionsList.Options.tables.list.mybookings.map(col => col.columnDef);
        ...
        this._diningService.getLabels({ 'meta_key': 'status_label' }).subscribe(response => {
            this.statusLabel = JSON.parse(response.settingsinfo.meta_value);
            console.log('statys', this.statusLabel);
        });
        ...
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
                if (result) {
                    ...
                    let deleteUrl = 'diningreservation/delete/diningbookingdelete';
                    console.log('deletedata', deleteData);
                    this._diningService.deleteBooking(deleteUrl, deleteData)
    ...
    statusChange(element, event) {
        ...
        this._diningService.updateBookingStatus(value)
            .subscribe(response => {
...
export class FilesDataSource extends DataSource<any>
{
    ...
    constructor(
        ...
        this.filteredData = this._diningService.bookingList;
    }
    ...
    connect(): Observable<DiningReservationmodel[]> {
        const displayDataChanges = [
            this._diningService.onBookingsChanged
        ];
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                    let data = this._diningService.bookingList;
    ...
    getFilteredBookings(params: any) {
        return this._diningService.getBookingList(params).then(Response => {
            return Response;
        });
    }
    /**
