...
import { AppConfig, CommonService, TabelReservationService } from 'app/_services';
...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    ...
    private tablereservationsetting: TabelReservationService,) {
  ...
  ngOnInit() {
    ...
    this.tablereservationsetting.getServices({ 'status': 'A' }).subscribe(response => {
  ...
  get_servicedata(selecteddate) {
    this.tablereservationsetting.viewService({ 'id': this.service_id, 'date': selecteddate }).subscribe(res => {
  ...
  getFilteredBookings(params: any) {
    return this.tablereservationsetting.getBookingDashboaList(params).then(Response => {
  ...
  bookingPrint(service_id) {
    ...
    return this.tablereservationsetting.getBookingDashboaList(this.filterParamsPrint).then(Response => {
