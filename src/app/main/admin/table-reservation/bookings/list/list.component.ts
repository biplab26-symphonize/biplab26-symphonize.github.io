...
import { OptionsList, CommonService, TabelReservationService, AppConfig, SettingsService } from 'app/_services';
...
export class ListComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        merge(this.sort.sortChange, this.paginator.page, this.filterForm.valueChanges)
            ...
            .subscribe(res => {
                ...
                //this.filterParams['column'] = 'booking_start_time';
                this.dataSource.getFilteredBookings(this.filterParams);

            });


        this._tableService.getServices({ 'status': 'A' }).subscribe(response => {
        ...
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
                if (result) {
                    ...
                    let deleteUrl = 'tablereservation/delete/tablebooking';

                    this._tableService.deleteBooking(deleteUrl, deleteData)
    ...
    statusChange(element, event) {
        ...
        this._tableService.updateBookingStatus(value)
            .subscribe(response => {
