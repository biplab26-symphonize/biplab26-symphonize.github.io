...
import { OptionsList, CommonService, MeetingRoomService, AppConfig } from 'app/_services';
  ...
  ngOnInit(): void
    {
        ...
        this.Columns          = OptionsList.Options.tables.list.equipments;
        this.displayedColumns = OptionsList.Options.tables.list.equipments.map(col => col.columnDef);
        ...
        .subscribe(res=>{
            ...
            this.dataSource.getFilteredEquipments(this.filterParams);
    ...
    deleteAll()
    {
        this.deleteEquipments(this.selection.selected)
    }
    /**ACTION FUNCTIONS */
    deleteEquipments(id){
        ...
        this.confirmDialogRef.componentInstance.confirmMessage = 'Are you sure you want to delete selected equipment?';
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
              if ( result )
              {
                ...
                let deleteUrl =  'meetingroom/delete/meetequipments';
                this._meetingRoomService.deleteEquipments(deleteUrl,deleteData)
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this._meetingRoomService.equipmentList;
    }
    ...
    connect(): Observable<MeetingRoommodel[]>
    {
        const displayDataChanges = [
            this._meetingRoomService.onEquipmentChanged
        ];
        return merge(...displayDataChanges)
            .pipe(
            map(() => {
                    let data          = this._meetingRoomService.equipmentList;
     ...
     * 
     */
    getFilteredEquipments(params:any){
        return this._meetingRoomService.getEquipmentList(params).then(Response=>{
            return Response;
        });
    }
    /**
