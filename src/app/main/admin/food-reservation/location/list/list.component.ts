...
export class ListComponent implements OnInit {
  ...
  //  exportDialogref: MatDialogRef<ExportComponent>; //EXTRA Changes  
    ...
    ngOnInit(): void
    {
        ...
        this.Columns          = OptionsList.Options.tables.list.mylocations;
        this.displayedColumns = OptionsList.Options.tables.list.mylocations.map(col => col.columnDef);
        ...
        .subscribe(res=>{
            ...
            this.dataSource.getFilteredLocations(this.filterParams);
        ...
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
              if ( result )
              {
                ...
                let deleteUrl =  'foodreservation/delete/foodlocation';
                console.log('deletedata',deleteData);
                this._foodService.deleteLocation(deleteUrl,deleteData)
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this._foodService.locationList;
    }
    ...
    connect(): Observable<FoodReservationmodel[]>
    {
        const displayDataChanges = [
            this._foodService.onLocationChanged
        ];
        return merge(...displayDataChanges)
            .pipe(
            map(() => {
                    let data          = this._foodService.locationList;
    ...
    getFilteredLocations(params:any){
        return this._foodService.getLocationList(params).then(Response=>{
            return Response;
        });
    }
    /**
