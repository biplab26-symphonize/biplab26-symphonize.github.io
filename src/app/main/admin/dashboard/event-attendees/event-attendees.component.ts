...
export class EventAttendeesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    setTimeout(() => {
      ...
      this.getEventAttendeesList(null);
      ...
      merge(this.paginator.page)
        ...
        .subscribe(res => {
          this.getEventAttendeesList(res);
        });
  ...
  //get Topiclist
  getEventAttendeesList(res) {
    this.filterParams['page'] = res == null ? 1 : res.pageIndex + 1;
    this.filterParams['limit'] = res === null ? 5 : res.pageSize;
    this._dashboardservice.getAttendeesList(this.filterParams).subscribe(response => {
