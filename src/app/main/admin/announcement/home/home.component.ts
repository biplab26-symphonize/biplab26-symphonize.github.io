...
export class HomeComponent implements OnInit {
    ...
    constructor(
        ...
        if (this.route.routeConfig.path == "admin/announcement/home/trash") {
            this.title = " Announcements Trash List";
            this.trash = true;
    ...
    */
    ngOnInit(): void {
        ...
        this.Columns = OptionsList.Options.tables.list.Home_announcement;
        this.displayedColumns = OptionsList.Options.tables.list.Home_announcement.map(col => col.columnDef);
        ...
        merge(this.sort.sortChange, this.paginator.page, this.filterForm.valueChanges)
            ...
            .subscribe(res => {
                ...
                this.trash == true ? this.filterParams['content_type'] = "home-announcement" : this.filterParams['content_type'] = "home-announcement";
    ...
    changeStatus(type: string = "A", selectid) {
        ...
        this._commonService.changeStatus({ 'id': contentid, 'status': type, 'type': 'Content' })
            .subscribe(statusResponse => {
                ...
                this.selection.clear();
                this.filterParams = CommonUtils.getFilterJson(this.sort, this.paginator, this.filterForm.value);
                this.filterParams['content_type'] = "home-announcement";
                this.filterParams['column'] = 'order';                
                this.dataSource.getFilteredAnnouncement(this.filterParams);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    constructor(
        ...
        data = this.filterData(this.filteredData);
