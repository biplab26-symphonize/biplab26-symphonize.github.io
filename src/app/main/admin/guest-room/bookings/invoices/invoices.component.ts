...
export class InvoicesComponent implements OnInit {
  ...
  //  exportDialogref: MatDialogRef<ExportComponent>; //EXTRA Changes  
    ...
    ngOnInit(): void
    {
        ...
        this.Columns          = OptionsList.Options.tables.list.myinvoices;
        this.displayedColumns = OptionsList.Options.tables.list.myinvoices.map(col => col.columnDef);
        ...
        .subscribe(res=>{
            ...
            this.dataSource.getFilteredExtras(this.filterParams);
    ...
    deleteAll()
    {
        this.deleteExtras(this.selection.selected)
    }
    /**ACTION FUNCTIONS */
    deleteExtras(id){
        ...
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
              if ( result )
              {
                ...
                let deleteUrl =  'guestroom/delete/invoice';
                this._guestroomService.permenentDeleteinvoices(deleteUrl,deleteData)
...
//    [routerLink]="'admin/guest-room/room/invoices/lists'"
    ...
    statusChange(id,event)
    {
        ...
        this._guestroomService.updateInvoicesStatus(value)
        .subscribe(response =>
        {
    ...
    Sendemail(id){
        ...
        this._guestroomService.getinvoicesemail(value)
        .subscribe(response =>
        { 
            this.showSnackBar(response.message, 'CLOSE');
            this.filterParams = CommonUtils.getFilterJson(this.sort,this.paginator,this.filterForm.value);
     ...
     printdata(id){
        ...
        params.push(    
            ...
            this._guestroomService.getPrintfromlistentries('guestroom/view/invoice',params);
    }
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this._guestroomService.invoicesList;
    }
    ...
    connect(): Observable<GuestRoommodel[]>
    {
        const displayDataChanges = [
            this._guestroomService.oninvlocesChanged
        ];
        return merge(...displayDataChanges)
            .pipe(
            map(() => {
                    let data          = this._guestroomService.invoicesList;                    
    ...
    getFilteredExtras(params:any){
        return this._guestroomService.getInvoicesList(params).then(Response=>{
            return Response;
        });
    }
    /**
