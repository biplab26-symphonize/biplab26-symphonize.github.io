...
export class LimitComponent implements OnInit {
  ...
  //  exportDialogref: MatDialogRef<ExportComponent>; //EXTRA Changes  
    ...
    ngOnInit(): void
    {
        ...
        this.Columns          = OptionsList.Options.tables.list.mylimit;
        this.displayedColumns = OptionsList.Options.tables.list.mylimit.map(col => col.columnDef);
        ...
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
              if ( result )
              {
                ...
                let deleteUrl =  'guestroom/delete/limits';
    ...
    statusChange(element,event)
    {
        ...
        this._guestroomService.updateLimtStatus(value)
        .subscribe(response =>
        {
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this._guestroomService.limitList;
    }
    ...
    connect(): Observable<GuestRoommodel[]>
    {
        const displayDataChanges = [
            this._guestroomService.onlimitChanged
        ];
        return merge(...displayDataChanges)
            .pipe(
            map(() => {
                    let data          = this._guestroomService.limitList;
                    console.log(data);
    ...
    getFilteredExtras(params:any){
        return this._guestroomService.getLimitsList(params).then(Response=>{
            return Response;
        });
    }
    /**
