...
export class ListPackagesComponent implements OnInit {
  ...
  //  exportDialogref: MatDialogRef<ExportComponent>; //EXTRA Changes  
    ...
    ngOnInit(): void
    {
        ...
        this.Columns          = OptionsList.Options.tables.list.mypackages;
        this.displayedColumns = OptionsList.Options.tables.list.mypackages.map(col => col.columnDef);
        ...
        .subscribe(res=>{
            ...
            this.dataSource.getFilteredPackage(this.filterParams);
    ...
    deleteAll()
    {
        this.deletePackage(this.selection.selected)
    }
    /**ACTION FUNCTIONS */
    deletePackage(id){    
        ...
        this.confirmDialogRef.componentInstance.confirmMessage = 'Are you sure you want to delete selected package?';
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
              if ( result )
              {
                ...
                let deleteUrl =  'guestroom/delete/package';
...
export class FilesDataSource extends DataSource<any>
{
     ...
     * 
     */
    getFilteredPackage(params:any){
        return this._guestroomService.getpackagesList(params).then(Response=>{
            return Response;
        });
    }
    /**
