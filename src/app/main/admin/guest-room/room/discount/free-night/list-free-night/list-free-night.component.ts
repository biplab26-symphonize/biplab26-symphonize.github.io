...
@Component({
  selector: 'app-list-free-night',
  templateUrl: './list-free-night.component.html',
  styleUrls: ['./list-free-night.component.scss'],
  animations   : fuseAnimations,
  encapsulation: ViewEncapsulation.None
})
export class ListFreeNightComponent implements OnInit {
...
//  exportDialogref: MatDialogRef<ExportComponent>; //EXTRA Changes  
  ...
  ngOnInit(): void
  {
      ...
      this.Columns          = OptionsList.Options.tables.list.myfreenight;
      this.displayedColumns = OptionsList.Options.tables.list.myfreenight.map(col => col.columnDef);
      ...
      .subscribe(res=>{
          ...
          this.dataSource.getFilteredFreeNights(this.filterParams);
  ...
  deleteAll()
  {
      this.deleteFreeNights(this.selection.selected)
  }
  /**ACTION FUNCTIONS */
  deleteFreeNights(id){    
      ...
      this.confirmDialogRef.componentInstance.confirmMessage = 'Are you sure you want to delete selected free night?';
      this.confirmDialogRef.afterClosed()
          .subscribe(result => {
            if ( result )
            {
              ...
              let deleteUrl =  'guestroom/delete/freenight';
...
export class FilesDataSource extends DataSource<any>
{
   ...
   * 
   */
  getFilteredFreeNights(params:any){
      return this._guestroomService.getFreeNightsList(params).then(Response=>{
          return Response;
      });
  }
  /**
