...
export class UnavailableListComponent implements OnInit {
  ...
  //  exportDialogref: MatDialogRef<ExportComponent>; //EXTRA Changes  
    ...
    ngOnInit(): void
    {
        ...
        this.Columns          = OptionsList.Options.tables.list.myunavailable;
        this.displayedColumns = OptionsList.Options.tables.list.myunavailable.map(col => col.columnDef);
    ...
    deleteAll()
    {
        this.deleteUnavaliableRooms(this.selection.selected)
    }
    /**ACTION FUNCTIONS */
    deleteUnavaliableRooms(id){    
        this.confirmDialogRef = this._matDialog.open(FuseConfirmDialogComponent, {
            disableClose: false
        });
  
        this.confirmDialogRef.componentInstance.confirmMessage = 'Are you sure you want to delete selected unavaliable rooms?';
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
              if ( result )
              {
                ...
                let deleteUrl =  'guestroom/delete/roomrestriction';
                this._guestroomService.deleteUnavaliableRooms(deleteUrl,deleteData)
...
export class FilesDataSource extends DataSource<any>
{
    ...
    getFilteredExtras(params:any){
        return this._guestroomService.getUnavailableList(params).then(Response=>{
            return Response;
        });
    }
    /**
