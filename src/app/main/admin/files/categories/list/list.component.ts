...
export class ListComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.Columns = OptionsList.Options.tables.list.filecategories;
        this.displayedColumns = OptionsList.Options.tables.list.filecategories.map(col => col.columnDef);
        ...
        this.isTrashView = this.route.routeConfig.path == 'admin/files/categories/trash' ? true : this.isTrashView;
    ...
    deleteCategory(catId: number = 0) {
        ...
        this.confirmDialogRef.componentInstance.confirmMessage = 'Are you sure you want to delete selected role?';
    ...
    restoreOrDeleteCategory(catId: number = 0, permenent: boolean = false) {
        ...
        let confirmMessage = 'Are you sure you want to restore selected category?';
        let apiEndPoint = 'categoriesrestore';
        //set ApiEndPoint as per flag
        if (permenent == true) {
            confirmMessage = 'Are you sure you want to delete selected category? category cannot be restored';
