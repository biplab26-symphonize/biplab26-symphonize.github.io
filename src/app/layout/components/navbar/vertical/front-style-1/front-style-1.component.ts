...
import { MenusService, AuthService } from 'app/_services';

@Component({
    selector     : 'front-vertical-style-1',
    templateUrl  : './front-style-1.component.html',
    styleUrls    : ['./front-style-1.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class NavbarFrontVerticalStyle1Component implements OnInit, OnDestroy
{
    fuseConfig: any;
    navigation: any;
