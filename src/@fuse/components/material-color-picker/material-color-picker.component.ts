...
export class FuseMaterialColorPickerComponent implements ControlValueAccessor
{
    ...
    updateSelectedColor(): void
    {
        ...
        this.selectedColor = {
            ...
            fg     : this.selectedPalette === '' ? '' : MatColors.getColor(this.selectedPalette) && MatColors.getColor(this.selectedPalette).contrast[this.selectedHue] ? MatColors.getColor(this.selectedPalette).contrast[this.selectedHue] : ''
        };
